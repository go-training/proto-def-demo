...
const (
	...
	GiteaServiceName = "proto.v1.GiteaService"
)

// GiteaServiceClient is a client for the proto.v1.GiteaService service.
...
// NewGiteaServiceClient constructs a client for the proto.v1.GiteaService service. By default, it
...
func NewGiteaServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GiteaServiceClient {
	...
	return &giteaServiceClient{
		gitea: connect_go.NewClient[v1.GiteaRequest, v1.GiteaResponse](
			httpClient,
			baseURL+"/proto.v1.GiteaService/Gitea",
			opts...,
		),
	}
}
...
// Gitea calls proto.v1.GiteaService.Gitea.
...
// GiteaServiceHandler is an implementation of the proto.v1.GiteaService service.
...
func NewGiteaServiceHandler(svc GiteaServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/proto.v1.GiteaService/Gitea", connect_go.NewUnaryHandler(
		"/proto.v1.GiteaService/Gitea",
		svc.Gitea,
		opts...,
	))
	return "/proto.v1.GiteaService/", mux
}
...
func (UnimplementedGiteaServiceHandler) Gitea(context.Context, *connect_go.Request[v1.GiteaRequest]) (*connect_go.Response[v1.GiteaResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("proto.v1.GiteaService.Gitea is not implemented"))
}
