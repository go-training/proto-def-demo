...
const (
	...
	PingServiceName = "proto.v1.PingService"
)

// PingServiceClient is a client for the proto.v1.PingService service.
type PingServiceClient interface {
	Ping(context.Context, *connect_go.Request[v1.PingRequest]) (*connect_go.Response[v1.PingResponse], error)
}

// NewPingServiceClient constructs a client for the proto.v1.PingService service. By default, it
...
func NewPingServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) PingServiceClient {
	...
	return &pingServiceClient{
		ping: connect_go.NewClient[v1.PingRequest, v1.PingResponse](
			httpClient,
			baseURL+"/proto.v1.PingService/Ping",
			opts...,
		),
	}
}
...
// Ping calls proto.v1.PingService.Ping.
...
// PingServiceHandler is an implementation of the proto.v1.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/proto.v1.PingService/Ping", connect_go.NewUnaryHandler(
		"/proto.v1.PingService/Ping",
		svc.Ping,
		opts...,
	))
	return "/proto.v1.PingService/", mux
}
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect_go.Request[v1.PingRequest]) (*connect_go.Response[v1.PingResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("proto.v1.PingService.Ping is not implemented"))
}
